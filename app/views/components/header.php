      ...
      <div class='flex flex-wrap justify-center px-10 py-3 relative'>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href='/'
              class='hover:text-[#007bff] text-gray-800 text-[15px] block'>Home</a></li>
            <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href='javascript:void(0)'
              class='hover:text-[#007bff] text-gray-800 text-[15px] block'>Blog</a></li>
            <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href='/about'
              class='hover:text-[#007bff] text-gray-800 text-[15px] block'>About</a></li>
            <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href='/contact'
              class='hover:text-[#007bff] text-gray-800 text-[15px] block'>Contact</a></li>
            <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href='/service'
